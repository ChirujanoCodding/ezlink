...
export default function Login() {
  return (
    <div>
        <div className='flex min-h-screen flex-col items-center justify-center bg-gradient-to-t from-blue-300 to-blue-500'>
    <div className='rounded-xl bg-gray-900 p-24 pb-12 pt-10 w-96 flex-col justify-center items-center'>
        ...
        <a><p className='text-sm text-center text-gray-500 mt-5'>Forgot password?</p></a>
        ...
        <div className='flex justify-center items-center mt-12'>
        <a><p className='text-sm text-center text-gray-500 mt-5 w-max'>Don´t have an account? Sign Up</p></a>
        </div>
    </div>
</div>
