         ...
         hover:duration-300"
          ...
          <div className="flex justify-center items-center mt-5 gap-4">
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-google hover:cursor-pointer hover:scale-110"
              viewBox="0 0 16 16"
            >
            ...
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-facebook hover:cursor-pointer hover:scale-110"
              viewBox="0 0 16 16"
            >
            ...
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-twitter-x hover:cursor-pointer hover:scale-110"
              viewBox="0 0 16 16"
            >
